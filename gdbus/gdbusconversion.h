...
#ifndef __G_DBUS_CONVERSION_H__
...
GVariant *_g_dbus_dbus_1_to_gvariant (DBusMessage  *message,
                                      GError      **error);

gboolean _g_dbus_gvariant_to_dbus_1 (DBusMessage  *message,
                                     GVariant     *value,
                                     GError      **error);
